    ...
    public class AccountController:Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if(result.Succeeded)
            {
                ...
                // email
                await _emailSender.SendEmailAsync(model.Email, "Confirm your account", $"Please click the link to confirm your email account: <a href='https://localhost:5001{url}'>here</a>.");
